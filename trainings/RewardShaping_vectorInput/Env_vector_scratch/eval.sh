...
#IT SHOULD BE LAUNCHED ON MY LOCAL MACHINE!!!!!!!
...
PYTHONPATH="$HOME/ClusterGPU/data_GPU/hassan/SurgerySimulator/ml-agents/:"
export PYTHONPATH
#export PATH=$PATH:$HOME/.local/bin/:

export LD_LIBRARY_PATH=/usr/local/cuda/lib64:$LD_LIBRARY_PATH

python3.5 ../../../mlagents/trainers/learn.py config.yaml --run-id=cataractEnv-vector --load --env=cataractEnv-vec.x86_64 --slow

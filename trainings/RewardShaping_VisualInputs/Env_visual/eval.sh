...
PYTHONPATH="$HOME/Desktop/ml-agents-master/ml-agents/:"
export PYTHONPATH
#export PATH=$PATH:$HOME/.local/bin/:

export LD_LIBRARY_PATH=/usr/local/cuda/lib64:$LD_LIBRARY_PATH

python3.5 ../../mlagents/trainers/learn.py config.yaml --run-id=cataractEnv-visual --load --env=cataractEnv.x86_64 --slow
